...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        //拼接代码生成后存放的路径
        //下面这句话的作用是获取此项目的父路径：即D:\ideaworkspace\huiminpay
        String projectPath = System.getProperty("user.dir");
        //当前项目名
        String projectName = "/generator";
        //拼接的路径为：D:/ideaworkspace/huiminpay/generator/src/main/java
        globalConfig.setOutputDir(projectPath + projectName+"/src/main/java");

        //设置生成代码的作者
        globalConfig.setAuthor("杜鹏飞");
		...
		// 商户服务的库
		dataSourceConfig.setUrl("jdbc:mysql://localhost:3306/huiminpay_merchant_service?serverTimezone=Asia/Shanghai");

		// 交易服务的库
        //dataSourceConfig.setUrl("jdbc:mysql://localhost:3306/huiminpay_merchant_service?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai");
